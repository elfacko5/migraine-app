...
- **Tokens live in `src/index.css` under `@theme`.** `--color-bg-base` `#1b1a18` · `--color-text-primary` `#cdc7bb` · `--color-accent` `#7fa187` · severity low/mid/high `#7fa187` / `#b07a3c` (muted amber) / `#a65a52` (desaturated terracotta).
