...
export function TextScalePill({ scale, onScale }: Props) {
  ...
  return (
    <button
      ...
      className="absolute bottom-[5.5rem] right-4 z-30 flex h-10 w-10 items-center justify-center rounded-full bg-bg-raised font-bold text-text-secondary ring-1 ring-bg-border hover:bg-bg-border active:scale-95 transition-all"
