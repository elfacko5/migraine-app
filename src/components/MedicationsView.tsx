...
export function MedicationsView({ medications, onAdd, onUpdate, onRemove, onClose }: Props) {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
      {/* Own top bar — Sheet is in `bareHeader` mode, same as AttackDetail. */}
      <div
      ...
      >
        ...
        <h2 className="flex-1 text-center text-base font-semibold text-text-primary">My medications</h2>
